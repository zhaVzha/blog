...
<body>
    ...
    <div class="blog-masthead">
        <div class="container">
            <nav class="blog-nav">
                ...
                <a class="blog-nav-item" href="#">随笔</a>
                <a class="blog-nav-item" href="#">其他</a>
                <a class="blog-nav-item" href="#">PAT</a>
    ...
    <script>window.jQuery || document.write('<script src="<%=path%>/js/vendor/jquery.min.js"><\/script>')</script>
